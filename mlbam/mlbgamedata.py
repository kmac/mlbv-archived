...
class MLBGameData(gamedata.GameData):
    ...
    def _get_game_data(self, date_str=None, overwrite_json=True):
        ...
        json_data = MLBGameData._fetch_json_from_url(url, 'top', overwrite_json)
        ...
        for game in json_data['dates'][0]['games']:
            ...
            live_data = MLBGameData._fetch_json_from_url(live_url, 'live', overwrite_json)
            ...
            if 'currentInningOrdinal' in live_data['liveData']['linescore']:
                ...
                game_rec['linescore']['inningState'] = str(live_data['liveData']['linescore']['inningState'])
            else:
            ...
            content_json = MLBGameData._fetch_json_from_url(content_url, 'content', overwrite_json)
